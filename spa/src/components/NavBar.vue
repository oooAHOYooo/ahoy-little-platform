<template>
  <!-- Same structure as Flask base.html: mobile-footer-logo, mobile-secondary-nav, mobile-bottom-nav -->
  <div class="mobile-only">
    <!-- Mobile Footer Logo (Flask: often hidden via combined.css) -->
    <div class="mobile-footer-logo mobile-only">
      <img :src="logoUrl" alt="Ahoy" class="mobile-footer-logo-img" />
    </div>
    <!-- Mobile Secondary Navigation — 5 tabs (Artists, Merch, Events, Profile, Saved) -->
    <nav class="mobile-secondary-nav mobile-only" role="navigation" aria-label="Secondary Navigation">
    ...
    <!-- Mobile Bottom Navigation — 6 tabs (Home, Music, Podcasts, Live TV, Videos, Radio) -->
    <nav class="mobile-bottom-nav mobile-only" role="navigation" aria-label="Media Navigation">
