...
@app.route('/debug/mobile-nav', methods=['POST'])
def debug_mobile_nav():
    """Debug endpoint for mobile navigation - logs to terminal"""
    try:
        data = request.get_json()
        timestamp = datetime.now().strftime('%H:%M:%S')
        
        if data.get('event') == 'page_loaded':
            print(f"\n🔍 [{timestamp}] MOBILE NAV DEBUG - Page Loaded:")
            print(f"   Alpine.js loaded: {data.get('alpine_loaded')}")
            print(f"   Alpine.js version: {data.get('alpine_version')}")
            print(f"   Window width: {data.get('window_width')}px")
            print(f"   Should show mobile nav: {data.get('should_show_mobile')}")
            
        elif data.get('event') == 'left_menu_clicked':
            print(f"\n🍔 [{timestamp}] LEFT MENU CLICKED:")
            print(f"   State before: {data.get('state_before')}")
            print(f"   State after: {data.get('state_after')}")
            
        elif data.get('event') == 'right_menu_clicked':
            print(f"\n🍔 [{timestamp}] RIGHT MENU CLICKED:")
            print(f"   State before: {data.get('state_before')}")
            print(f"   State after: {data.get('state_after')}")
            
        elif data.get('event') == 'left_menu_state_changed':
            print(f"\n👀 [{timestamp}] LEFT MENU STATE CHANGED:")
            print(f"   New state: {data.get('new_state')}")
            
        elif data.get('event') == 'right_menu_state_changed':
            print(f"\n👀 [{timestamp}] RIGHT MENU STATE CHANGED:")
            print(f"   New state: {data.get('new_state')}")
            
        elif data.get('event') == 'left_dropdown_debug':
            print(f"\n🔍 [{timestamp}] LEFT DROPDOWN DEBUG:")
            print(f"   Display: {data.get('display')}")
            print(f"   Visibility: {data.get('visibility')}")
            print(f"   Position: {data.get('position')}")
            print(f"   Z-Index: {data.get('zIndex')}")
            print(f"   Opacity: {data.get('opacity')}")
            
        elif data.get('event') == 'right_dropdown_debug':
            print(f"\n🔍 [{timestamp}] RIGHT DROPDOWN DEBUG:")
            print(f"   Display: {data.get('display')}")
            print(f"   Visibility: {data.get('visibility')}")
            print(f"   Position: {data.get('position')}")
            print(f"   Z-Index: {data.get('zIndex')}")
            ...
            print(f"\n🔍 [{timestamp}] LEFT DROPDOWN DEBUG:")
            print(f"   Dropdown found: {data.get('dropdown_found')}")
            print(f"   Total dropdowns: {data.get('total_dropdowns')}")
            print(f"   State value: {data.get('state_value')}")
            print(f"   Dropdown classes: {data.get('dropdown_classes')}")
        ...
        elif data.get('event') == 'left_dropdown_styles':
            print(f"\n🎨 [{timestamp}] LEFT DROPDOWN STYLES:")
            print(f"   Display: {data.get('display')}")
            print(f"   Visibility: {data.get('visibility')}")
            print(f"   Position: {data.get('position')}")
            print(f"   Z-Index: {data.get('zIndex')}")
        ...
        elif data.get('event') == 'right_dropdown_styles':
            print(f"\n🎨 [{timestamp}] RIGHT DROPDOWN STYLES:")
            print(f"   Display: {data.get('display')}")
            print(f"   Visibility: {data.get('visibility')}")
            print(f"   Position: {data.get('position')}")
            print(f"   Z-Index: {data.get('zIndex')}")
